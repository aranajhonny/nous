...
$html = "";
if(isset($_SESSION['progmant']['confunid'])){ 

include("../composiciones/composiciones_CompUnid.php");
$rs=pg_query("select id_composicion, nombre from composiciones where id_dependencia=0 and id_confunid = ".$_SESSION['progmant']['confunid']." order by nombre asc");
