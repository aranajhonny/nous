...
$_SESSION['acc']['mod'] = 26;
$_SESSION['acc']['form'] = 53;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Unidade de Medida",0);
...
<div class="header">Listado Unidad de Medida
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_unidmed, unidmed.nombre, magnitudes.nombre from unidmed, magnitudes where unidmed.id_magnitud = magnitudes.id_magnitud order by magnitudes.nombre, unidmed.nombre asc"));
$r = pg_num_rows($rs);
if($r!=false && $r>0){ $i=1; while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(330,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Unidad de Medida"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?unidmed=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(224,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Unidad de Medida" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?unidmed=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(84,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Unidad de Medida" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
