...
<label>Porcentaje de Tolerancia:<input type="text" name="porc" id="porc" value="0" readonly="readonly" size="4" />%</label>
...
$("#slider").slider({
    ...
    min: 1,
	max: 100,
	slide: function (event, ui) { document.getElementById('porc').value=ui.value; }
});</script>
    </body>
</html>