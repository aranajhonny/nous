            ...
            <div class="container">
                ...
                <div class="row">
                	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                    <div class="well">
	                    	<div class="header">Select2 <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<div class="row">
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						    		<p class="text-muted">
				                    	<small>Turns this</small>
			                    	</p>
	                    	...
	                    	<div class="row">
						    	...
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
			                    	...
			                    	<div class="form-group">
				                    	<select id="e2" multiple="multiple">
											<option value="AK">Alaska</option>
							                <option value="HI">Hawaii</option>
							                <option value="CA">California</option>
							                <option value="NV">Nevada</option>
	                    ...
	                    <div class="well">
	                    	<div class="header">Even More Select2 <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<div class="row">
						    	...
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
			                    	<div class="form-group">
			                    		<select id="e9_2" multiple="multiple">
			                    	...
			                    	<div class="row">
			                    		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			                    			<button id="e9_enable" class="btn btn-success">Enable</button>
			                    		</div>
			                    		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			                    			<button id="e9_disable" class="btn btn-danger">Disable</button>
			                    		</div>
			                    	</div>
						    	</div>
	                    	</div>
	                ...
	                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                    <div class="well">
	                    	<div class="header">More Select2 <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<div class="row">
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						    		<p class="text-muted">
				                    	<small>Multiple Placeholders</small>
			                    	</p>
			                    	<div class="form-group">
			                    		<select id="e3" multiple="multiple">
										    <option value="cheese">Cheese</option>
											  <option value="tomatoes">Tomatoes</option>
											  <option value="mozarella">Mozzarella</option>
											  <option value="mushrooms">Mushrooms</option>
						    	...
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						    		<p class="text-muted">
				                    	<small>Placeholders with Remover</small>
			                    	</p>
			                    	<div class="form-group">
			                    		<select id="e4">
										    <option value="cheese">Cheese</option>
	                    	...
	                    	<div class="row">
						    	...
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						    		<p class="text-muted">
				                    	<small>Maximum Selection Size (3)</small>
			                    	</p>
			                    	<div class="form-group">
			                    		<select id="e6" multiple="multiple">
										    <option value="cheese">Cheese</option>
											  <option value="tomatoes">Tomatoes</option>
											  <option value="mozarella">Mozzarella</option>
											  <option value="mushrooms">Mushrooms</option>
	                    	...
	                    	<div class="row">
						    	...
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						    		<p class="text-muted">
				                    	<small>Select2 Lifecycle</small>
			                    	</p>
			                    	<div class="form-group">
			                    		<select id="e8" multiple="multiple">
										    <option value="cheese">Cheese</option>
											  <option value="tomatoes">Tomatoes</option>
											  <option value="mozarella">Mozzarella</option>
											  <option value="mushrooms">Mushrooms</option>
			                    	...
			                    	<div class="row">
			                    		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			                    			<button id="e8_init" class="btn btn-success btn-gap">Init</button>
			                    		</div>
			                    		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			                    			<button id="e8_destroy" class="btn btn-danger btn-gap">Destroy</button>
			                    		</div>
			                    	</div>
						    	</div>
	                    	</div>
	                    	<div class="row">
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
			                    	...
			                    	<div class="form-group">
			                    		<select id="e10" multiple="multiple">
								            <optgroup label="Alaskan/Hawaiian Time Zone">
								                <option value="AK">Alaska</option>
								                <option value="HI">Hawaii</option>
								            </optgroup>
								    ...
								    <button id="e10_set" class="btn btn-default btn-gap">Set to California and Massachusetts</button>
						    	</div>
						    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						    		<p class="text-muted">
			                    	...
			                    	<div class="row">
			                    		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			                    			<button id="e11_open" class="btn btn-default btn-gap">Open</button>
			                    		</div>
			                    		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			                    			<button id="e11_close" class="btn btn-default btn-gap">Close</button>
			                    		</div>
			                    	</div>
			                    	<div class="form-group">
			                    		<select id="e11">
