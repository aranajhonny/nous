						    ...
						    <div class="row">
		                		...
		                		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center">
		                			<ul class="list-unstyled">
		                				...
		                				<li>Duis gravida mauris arcu</li>
		                				<li>Et suscipit mi dictum condimentum</li>
		                				<li>Phasellus pretium dolor at</li>
		                			</ul>
		                		</div>
		                		<hr class="visible-xs">
		                		...
		                		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center">
		                			...
		                			<p>
			                			...
			                			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis gravida mauris arcu, et suscipit mi dictum condimentum. Phasellus pretium dolor at justo congue tincidunt.
			                			 <i class="fa fa-quote-right"></i>
		                			</p>
		                			<p class="text-right text-muted">- James Smith</p>
		                		</div>
		                	</div>
		                </div>
		            </div>
