...
<html lang="en">
    <head>
        ...
        <title>Legend</title><?php echo "<link href='assets/bootstrap/css/bootstrap.css' rel='stylesheet'>
<link href='assets/css/styles.css' rel='stylesheet'><link href='assets/css/leftmenu.css' rel='stylesheet'>"; ?>
        <!--[if lt IE 9]>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                    <div class="well">
	                    	<div class="header">Validation with Happy JS <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<form id="awesomeForm" role="form" method="post">
	                    ...
	                    <div class="well">
	                    	<div class="header">Bootstrap Acknowledge Inputs <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Any Input validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <input type="text" required placeholder="Any Text Required" class="form-control" data-type="text" >
	                    	...
	                    	<div class="form-group">
			                    ...
			                    <div class="input-group" data-role="acknowledge-input">
								  <input type="text" required placeholder="Email Required" class="form-control" data-type="email" >
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								</div>
	                    	</div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Telephone Number validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <input type="text" required placeholder="Telephone Number Required" class="form-control" data-type="tel">
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								</div>
	                    	</div>
	                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                    <div class="well">
	                    	<div class="header">More Bootstrap Acknowledge Inputs <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Number validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <input type="text" required placeholder="Number Required" class="form-control" data-type="number">
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								</div>
	                    	</div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Integer validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <input type="text" required placeholder="Integer Required" class="form-control" data-type="integer" >
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								</div>
	                    	</div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Decimal Number validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <input type="text" required placeholder="Decimal Required" class="form-control" data-type="decimal">
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								</div>
	                    	</div>
	                    </div>
	                    <div class="well">
	                    	<div class="header">Even More Bootstrap Acknowledge Inputs <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Currency validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								  <input type="text" required placeholder="Currency Required" class="form-control" data-type="currency">
								</div>
	                    	</div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
						  			<small>Colour validation</small>
						  		</p>
			                    <div class="input-group" data-role="acknowledge-input">
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								  <input type="text" required placeholder="Colour Required" class="form-control" data-type="colour" >
								</div>
	                    	</div>
	                    	<div class="form-group">
	                    		<p class="text-muted">
			                    ...
			                    <div class="input-group" data-role="acknowledge-input">
								  <span class="input-group-addon" data-role="acknowledgement"><i></i></span>
								  <input type="text" required placeholder="URL Required" class="form-control" data-type="url">
								</div>
	                    	</div>
	                    </div>
                    </div>
        ...
        <script src="assets/acknowledgeinputs/js/bootstrap-acknowledgeinput.min.js"></script>
        <script src="assets/happy/js/happy.js"></script>
