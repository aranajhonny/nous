...
<link href='assets/css/leftmenu.css' rel='stylesheet'>"; ?>
    ...
    <body>
		            	...
		            	<div class="well">
				            <div class="row">
			                    <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4">
			                        <div class="header">toastr</div>
				                    <ul class="list">
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Close Button</span>
				                    			<input id="closeButton" type="checkbox" value="checked" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                        	<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Add behavior on toast click</span>
				                    			<input id="addBehaviorOnToastClick" type="checkbox" value="checked" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Debug</span>
				                    			<input id="debugInfo" type="checkbox" value="checked" class="themecheck" />
				                    		</p>
				                    	</li>
				                    </ul>
				                    <ul class="list" id="toastTypeGroup">
				                    	<li class="divider">Type</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Success</span>
				                    			<input type="radio" name="toasts" value="success" class="themecheck" checked />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Info</span>
				                    			<input type="radio" name="toasts" value="info" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Warning</span>
				                    			<input type="radio" name="toasts" value="warning" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Error</span>
				                    			<input type="radio" name="toasts" value="error" class="themecheck" />
				                    		</p>
				                    	</li>
				                    </ul>
				                    <ul class="list" id="positionGroup">
				                    	<li class="divider">Position</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Top Right</span>
				                    			<input type="radio" name="positions" value="toast-top-right" class="themecheck" checked />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Bottom Right</span>
				                    			<input type="radio" name="positions" value="toast-bottom-right" class="themecheck"  />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Bottom Left</span>
				                    			<input type="radio" name="positions" value="toast-bottom-left" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Top Left</span>
				                    			<input type="radio" name="positions" value="toast-top-left" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Top Full Width</span>
				                    			<input type="radio" name="positions" value="toast-top-full-width" class="themecheck" />
				                    		</p>
				                    	</li>
				                    	<li>
				                    		<p class="text-right">
				                    			<span class="text-muted pull-left listlabel">Bottom Full Width</span>
				                    			<input type="radio" name="positions" value="toast-bottom-full-width" class="themecheck" />
				                    		</p>
				                    	</li>
				                    </ul>
			                    </div>
			                    <div class="col-xs-12 col-sm-7 col-md-8 col-lg-8">
			                    	...
			                    	<div class="form-group">
			                            <label for="timeOut">Extended time out</label>
			                            <input id="extendedTimeOut" type="text" placeholder="ms" class="form-control" value="1000" />
			                    	</div>
			                    	<div class="form-group">
							            <div class="btn-group btn-group-justified">
							                <a role="button" class="btn btn-primary" id="showtoast">Show Toast</a>
							                <a role="button" class="btn btn-danger" id="cleartoasts">Clear Toasts</a>
							                <a role="button" class="btn btn-warning" id="clearlasttoast">Clear Last Toast</a>
							            </div>
			                    	</div>
        ...
        <script src="assets/toastr/js/glimpse.toastr.js"></script>
        <script src="assets/js/leftmenu.js"></script>
        <script src="assets/js/theme.js"></script>
        <script src="assets/js/script.js"></script>
        <script>toastralerts();</script>
    </body>
</html>