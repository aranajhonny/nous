        ...
        <section class="wrap">
            <div class="container">
            	<ol class="breadcrumb">
					...
					<li><a href="#">Bootstrap Buttons</a></li>
					<li class="pull-right"><a href="" class="text-muted"><i class="fa fa-refresh"></i></a></li>
				</ol>
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="well">
                            <div class="header">Buttons <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-default btn-block">Default</button>
                                    <div class="padded text-center text-muted"><small>btn btn-default</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-primary btn-block">Primary</button>
                                    <div class="padded text-center text-muted"><small>btn btn-primary</small></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-success btn-block">Success</button>
                                    <div class="padded text-center text-muted"><small>btn btn-success</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-info btn-block">Info</button>
                                    <div class="padded text-center text-muted"><small>btn btn-info</small></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-warning btn-block">Warning</button>
                                    <div class="padded text-center text-muted"><small>btn btn-warning</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-danger btn-block">Danger</button>
                                    <div class="padded text-center text-muted"><small>btn btn-danger</small></div>
                                </div>
                            </div>
                        </div>
                        <div class="well">
                            <div class="header">Button Sizes <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-default btn-block btn-lg">Large</button>
                                    <div class="padded text-center text-muted"><small>btn-lg</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-info btn-block btn-lg">Large</button>
                                    <div class="padded text-center text-muted"><small>btn-lg</small></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="padded text-center text-muted"><small>btn</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-info btn-block">Medium</button>
                                    <div class="padded text-center text-muted"><small>btn</small></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-default btn-block btn-sm">Small Medium</button>
                                    <div class="padded text-center text-muted"><small>btn-sm</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-info btn-block btn-sm">Small Medium</button>
                                    <div class="padded text-center text-muted"><small>btn-sm</small></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-default btn-block btn-xs">Extra Small</button>
                                    <div class="padded text-center text-muted"><small>btn-xs</small></div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <button type="button" class="btn btn-info btn-block btn-xs">Extra Small</button>
                                    <div class="padded text-center text-muted"><small>btn-xs</small></div>
                                </div>
                            </div>
                        </div>
                        <div class="well">
                            <div class="header">Quick Buttons <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                    <a class="quick-btn quick-btn-primary" href="#">
                                    <img src="assets/img/icons/login.png" alt="">
                                    </a>
                                </div>
                                <div class="clearfix visible-xs"></div>
                                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                    <a class="quick-btn quick-btn-success" href="#">
                                    <img src="assets/img/icons/pin.png" alt="">
                                    </a>
                                </div>
                                <div class="clearfix hidden-xs"></div>
                                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                    <a class="quick-btn quick-btn-info" href="#">
                                    <img src="assets/img/icons/link.png" alt="">
                                    </a>
                                </div>
                                <div class="clearfix visible-xs"></div>
                                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                    <a class="quick-btn quick-btn-warning" href="#">
                                    <img src="assets/img/icons/paperplane.png" alt="">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                    <a class="quick-btn quick-btn-danger" href="#">
                                    <img src="assets/img/icons/wrench.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="well">
                            <div class="header">Button Groups <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
                            <div class="btn-group">
                                <a class="btn btn-success" href="#">Success</a>
                                <a class="btn btn-info" href="#">Info</a>
                                <a class="btn btn-danger" href="#">Danger</a>
                            </div>
                            <div class="padded text-center text-muted"><small>btn-group</small></div>
                            <div class="btn-group btn-group-justified">
                                <a class="btn btn-danger" href="#">Danger</a>
                                <a class="btn btn-warning" href="#">Warning</a>
                                <a class="btn btn-primary" href="#">Primary</a>
                            </div>
                            <div class="padded text-center text-muted"><small>btn-group btn-group-justified</small></div>
                        </div>
                        <div class="well">
                            <div class="header">Button Groups Sizes <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
                            <div class="btn-group btn-group-lg btn-group-justified">
                                <a class="btn btn-default" href="#">Large</a>
                                <a class="btn btn-info" href="#">Large</a>
                            </div>
                            <div class="padded text-center text-muted"><small>btn-group btn-group-lg btn-group-justified</small></div>
                            <div class="btn-group btn-group-justified">
                                <a class="btn btn-default" href="#">Medium</a>
                                <a class="btn btn-info" href="#">Medium</a>
                            </div>
                            <div class="padded text-center text-muted"><small>btn-group btn-group-justified</small></div>
                            <div class="btn-group btn-group-sm btn-group-justified">
                                <a class="btn btn-default" href="#">Small Medium</a>
                                <a class="btn btn-info" href="#">Small Medium</a>
                            </div>
                            <div class="padded text-center text-muted"><small>btn-group btn-group-sm btn-group-justified</small></div>
                            <div class="btn-group btn-group-xs btn-group-justified">
                                <a class="btn btn-default" href="#">Extra Small</a>
                                <a class="btn btn-info" href="#">Extra Small</a>
                            </div>
                            <div class="padded text-center text-muted"><small>btn-group btn-group-xs btn-group-justified</small></div>
                        </div>
                        <div class="well">
                            <div class="header">Button Toolbars <a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
                            <div class="btn-toolbar">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a class="btn btn-default" href="#">9</a>
                                </div>
                            </div>
                            <div class="padded text-muted"><small>btn-toolbar</small></div>
                            <div class="btn-group">
                            ...
                            <div class="padded text-muted"><small>btn-toolbar width dropdown</small></div>
                        </div>
                    </div>
                </div>
            </div>
