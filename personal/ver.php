...
$_SESSION['acc']['mod'] = 31;
$_SESSION['acc']['form'] = 72;
include("../complementos/permisos.php");

if(isset($_REQUEST['pers'])){ $_SESSION['personal']=filtrar_campo('int', 6, $_REQUEST['pers']); }

if(isset($_SESSION['personal'])){
$rs = pg_query($link, filtrar_sql("select ci, nombre, rif, razon_social, cargos.descripcion, personal.telefono, email, id_area, id_zona, id_confunid, tipo_aviso from personal, clientes, cargos where personal.id_cargo = cargos.id_cargo and personal.id_cliente = clientes.id_cliente and id_personal = ".$_SESSION['personal']));
$r = pg_num_rows($rs);
if($r==false || $r<1){ 
...
<div class="header">Ver Personal<a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
<form name="agregar" method="post" action="ver.php">
<fieldset>

<div class="form-group"><label>C.I.</label>
<input id="ci" name="ci" type="text" placeholder="Cedula de Identidad" class="form-control"  value="<?php echo $ci;?>" readonly="readonly" /></div>
                                
<div class="form-group"><label>Primer Nombre y Apellido</label>
<input id="nom" name="nom" type="text" placeholder="Nombre y Apellido" class="form-control"  value="<?php echo $nom;?>" readonly="readonly" /></div>

<div class="form-group"><label>Télefono</label>
<input id="tlf" name="tlf" type="text" placeholder="Numero de Télefono" class="form-control" value="<?php echo $tlf;?>" readonly="readonly" /></div>

<div class="form-group"><label>Correo</label>
<input id="correo" name="correo" type="text" placeholder="Correo" class="form-control"  value="<?php echo $correo;?>" readonly="readonly" /></div>
...
<input id="cargo" name="cargo" type="text" placeholder="Cargo" class="form-control" value="<?php echo $cargo;?>" readonly="readonly" /></div>
...
<div class="form-group"><label>Tipo de Aviso</label>
<input id="aviso" name="aviso" type="text" placeholder="Tipo de Aviso" class="form-control" value="<?php echo $aviso;?>" readonly="readonly" /></div>
