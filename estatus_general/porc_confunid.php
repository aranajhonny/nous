...
$rs = pg_query($link, filtrar_sql("select count(id_unidad) from unidades where estatus_control <> 'Estable' and  unidades.id_cliente = $c and (unidades.id_confunid=$t or $t < 1)"));
...
<div style="border-bottom:2px solid #AAA; color:#AAA; font-size:12px; margin:0px; padding:0px; padding-bottom:5px; line-height:18px;"><strong style="font-size:20px;">&bull;</strong> % DE UNIDADES FUERA DE CONTROL SEGUN TIPO DE UNIDAD</div>
