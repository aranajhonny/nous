...
$_SESSION['acc']['mod'] = 56;
$_SESSION['acc']['form'] = 151;
include("../complementos/permisos.php");


Auditoria("Accedio Al Modulo de Notificaciones Listado",0);
...
<div class="header">Listado de Notificaciones 
...
$rs = pg_query($link, filtrar_sql("
select id_noti, notificaciones.id_alarma, alarmas.dresp, fecha_hora_enviado, fecha_hora_confirmacion, notificaciones.duracion_min, mensaje, confirmacion from notificaciones, alarmas, unidades where ((unidades.id_area = $a or $a < 1) and (unidades.id_zona = $z or $z < 1) and (unidades.id_confunid = $t or $t < 1)) and  alarmas.id_alarma = notificaciones.id_alarma and alarmas.id_unidad = unidades.id_unidad order by id_noti desc limit 500")); 
$r = pg_num_rows($rs);
...
<tr>
<td><div class=" info-tooltip"><img src="<?php echo $dir;?>" width="20" height="43" rel="tooltip" title="<?php echo $est;?>"  style="margin-right:10px;"/><?php echo $r[1];?></div></td>
<td><?php echo $r[6];?></td>
<td><?php echo $r[2];?></td>
...
<?php } } else {  ?>
<tr><td>NO HAY REGISTROS</td><td></td><td></td><td></td><td></td><td></td></tr>
<?php } ?>   
	</tbody>
...
<th><input type="text" name="area" id="area" placeholder="Buscar ID Alarma" class="search_init"  style="width:160px;" /></th>
<th><input type="text" name="fecha" placeholder="Buscar Mensaje" class="search_init" style="width:160px;" /></th>
<th><input type="text" name="zona" id="zona" placeholder="Buscar Responsable" class="search_init"  style="width:160px;" /></th>
...
<iframe src="ultimas_notificaciones.php" width="420" height="397" frameborder="0" scrolling="no"></iframe></div></div>
