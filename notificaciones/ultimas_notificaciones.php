				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row">
                            ...
                            <div class="col-sm-6 cf-item">
								<header>
									<p><span></span>Ultimas Notificaciones</p>
								</header>
...
$rs = pg_query($link, filtrar_sql("select dresp, mensaje, nro_control from notificaciones, alarmas where notificaciones.id_alarma = alarmas.id_alarma and (alarmas.id_cliente=$c or $c < 1) and 
((alarmas.id_area = $a or $a < 1) and (alarmas.id_zona = $z or $z < 1) and (alarmas.id_confunid = $t or $t < 1)) order by id_noti desc limit 36")); 
...
<p style="height:100px;"><?php echo " Responsable: ".$r[0]." Mensaje:  ".$r[1]." ".$r[2];?></p>
<?php for($i=0; $i<2; $i++){ if ( $r = pg_fetch_array($rs) ) { ?>
<p style="height:100px;"><?php echo " Responsable: ".$r[0]." Mensaje:  ".$r[1]." ".$r[2];?></p><?php } } ?></blockquote></div><?php $act=""; } } ?> 
