...
$_SESSION['acc']['mod'] = 51;
$_SESSION['acc']['form'] = 109;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Configuracion Guia de Despacho Listado",0);
...
<div class="header">Listado Configuración de la Guía de Despacho 
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select rif, razon_social, confguia.* from confguia, clientes where 
clientes.id_cliente = confguia.id_cliente order by nombre asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(344,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Configuración de la Guía de Despacho"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?confguia=<?php echo $r[2];?>'"/>
<?php } ?>

<?php if ( in_array(238,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Configuración de la Guía de Despacho" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?confguia=<?php echo $r[2];?>'" />
<?php } ?>

<?php if ( in_array(98,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Configuración de la Guía de Despacho" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
