...
$_SESSION['acc']['mod'] = 68;
$_SESSION['acc']['form'] = 175;
include("../complementos/permisos.php");


Auditoria("Accedio Al Modulo de Clasificación de Permiso Listado",0);

unset($_SESSION['clasperm']);
unset($_SESSION['clasperm_cliente']);
...
<ol class="breadcrumb">
<li><a href="#">Control de Permiso</a></li>
<li><a href="#">Clasificación de Permisos</a></li>
...
<div class="header">Clasificaciones de Permisos
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id, nom, rif, razon_social from clasperm, clientes  where clasperm.id_cliente = clientes.id_cliente order by nom asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ $i=1; while($r = pg_fetch_array($rs)){ ?>    
<tr>
<td><div class=" info-tooltip">

<?php if ( in_array(451,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Clasificación"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?clas=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(453,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Clasificación" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?clas=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(452,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Clasificación" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
