...
Auditoria("Accedio Al Modulo Listado Dispositivo del Cliente",0);

unset($_SESSION['dispcli']);
...
<div class="header">Listado de Dispositivos y Clientes
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_dispositivo, tipo_disp.descripcion, dispositivos.serial, id_cliente, estatus from tipo_disp, dispositivos where tipo_disp.id_tipo_disp = dispositivos.id_tipo_disp order by tipo_disp.descripcion, dispositivos.serial asc"));
$r = pg_num_rows($rs);
...
<img src="../img/pencil.png" width="15" height="15" title="Asignar Cliente al Dispositivo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?disp=<?php echo $r[0];?>'" />
</div></td>
<td><?php echo $cli;?></td>
