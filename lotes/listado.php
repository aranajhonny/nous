...
$_SESSION['acc']['mod'] = 17;
$_SESSION['acc']['form'] = 21;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Lotes Listado",0);
...
<div class="header">Listado de Lotes
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tr>
		...
		<th>Cantidad</th>
		<th>Inicio de Serial</th>
		
	</tr>
	</thead>
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_lote, nro, fecha_creacion, cantidad, serial_inicio from lotes order by fecha_creacion desc ")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr>
<td><div class=" info-tooltip">

<?php if ( in_array(322,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Lote"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?lote=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(216,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Lote" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?lote=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(76,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Lote" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>

</div></td><td><?php echo $r[1];?></td>
<td><?php echo date1($r[2]);?></td>
<td><?php echo $r[3];?></td>
<td><?php echo $r[4];?></td>
</tr>
<?php } } ?>    
