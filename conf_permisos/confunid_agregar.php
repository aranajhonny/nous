...
if(empty($cli)){ $_SESSION['mensaje1']="Debe seleccionar un cliente";
	...
	if($rs){ 
		...
		Auditoria("Se Agrego configuracion unidades: $nom",$rs[0]);

		$_SESSION['mensaje3']="Configuración de Unidad Agregada";
	...
	Auditoria("Accedio a Agregar Configuración de Unidad",0);
}
