...
Auditoria("Accedio Al Modulo Centro de Soporte",0);
...
table.table thead tr .acc,
table.table tbody tr .acc,
table.table tfoot tr .acc { max-width:100px; }
</style>
<!-- InstanceEndEditable -->
</head>
<body>
...
<div class="header">Listado de Tickeds 
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id, fr, est from soportes order by id desc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td class="acc"><div class=" info-tooltip">

<img src="../img/search.png" width="15" height="15"  title="Ver Ticked"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?support=<?php echo $r[0];?>'"/>

<img src="../img/plus.png" width="15" height="15" title="Agregar Ticked" style="margin: 0px 15px 0px 15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />

<?php if(strcmp($r[2],"Concluido")!=0){ ?>
<img src="../img/arrowleft.png" width="15" height="15" title="Atender Ticked" rel="tooltip" data-placement="right" onclick="location.href='editar.php?support=<?php echo $r[0];?>';" />
<?php } ?>
</div></td>
<td class="acc"><?php echo "#".$r[0];?></td>
