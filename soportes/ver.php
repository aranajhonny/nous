...
<div class="header">Ver Ticked<a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
<form name="agregar" method="post" action="ver.php" onsubmit="return validar();" enctype="multipart/form-data">
<fieldset>
...
<input id="fr" name="fr" type="text" placeholder="Fecha de Registro" class="form-control" value="<?php echo $_SESSION['support']['fr'];?>" readonly="readonly" /></div>
