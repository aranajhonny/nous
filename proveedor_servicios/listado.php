...
$_SESSION['acc']['mod'] = 44;
$_SESSION['acc']['form'] = 97;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Proveedor de Servicios Listado",0);
...
<div class="header">Listado Proveedores de Servicio
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_provserv, rif, nombre_prov, contacto, telefono, email from provserv order by rif asc ") ); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr>
<td><div class=" info-tooltip">

<?php if ( in_array(341,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Proveedor de Servicio"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?provserv=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(235,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Proveedor de Servicio" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?provserv=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(95,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Proveedor de Servicio" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
