...
$_SESSION['acc']['mod'] = 46;
$_SESSION['acc']['form'] = 105;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Plan de Mantenimiento Listado",0);

unset($_SESSION['planmant']);
unset($_SESSION['planmant_cliente']);
unset($_SESSION['planmant_conf']);
...
<div class="header">Listado Planes de Mantenimiento
...
<?php if ( in_array(343,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Plan de Mantenimiento"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?plan=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(237,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Plan de Mantenimiento" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?plan=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(97,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Plan de Mantenimiento" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>

</div></td>
<td><?php echo $r[1];?></td>
<td><?php echo $r[2];?></td>
<td><?php echo $tipo_sensor;?></td>
</tr>
<?php } } ?>    
	</tbody>
</table>
