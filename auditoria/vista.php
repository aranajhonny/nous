...
$_SESSION['acc']['mod'] = 59;
$_SESSION['acc']['form'] = 129;
include "../complementos/permisos.php";

Auditoria("Accedio Al Modulo de Auditoria", 0);
...
<div class="header">Vista de Movimientos
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select fr, UPPER(nom_u), accion from auditoria order by fr desc"));
$r = pg_num_rows($rs);
if ($r != false && $r > 0) {while ($r = pg_fetch_array($rs)) {?>
<tr>
<td class="extra"><?php echo date3($r[0]); ?></td>
...
<tfoot><tr>
<th class="extra"><input type="text" name="fr" id="fr" placeholder="Buscar Fecha y Hora" class="search_init" style="width:100px;" /></th>
<th class="extra"><input type="text" name="usu" id="sus" placeholder="Buscar Usuario" class="search_init"  style="width:100px;" /></th>
<th><input type="text" name="acc" id="acc" placeholder="Buscar Movimiento" class="search_init"  style="width:160px;" /></th>
</tr></tfoot>
