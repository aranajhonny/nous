...
<section class="login">
	<div class="login-panel" style="display: block;width: 450px;height: 250px;">
		<h3 class="text-muted">Recuperar Contraseña</h3>
		<form role="form" action="../complementos/recuperar.php" method="post">
				<div class="col-xs-8">
					<input class="form-control" placeholder="Correo electronico" type="email" name="email" id="email"/>
				</div>
				<span class="input-group-btn">
					<button class="btn btn-primary btn-lg" type="submit" name="inicio">Enviar</button>
				</span><br><br>
				<p><code>Usted recibirá un codigo de verificación válido para un solo uso.</code></p>
			</div>
		</form>
		<hr />
	</div>
