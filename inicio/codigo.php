...
<section class="login">
	<div class="login-panel" style="display: block;width: 450px;height: 250px;">
		<h3 class="text-muted">Introduzca su codigo de verficación</h3>
		<form role="form" action="../complementos/codigo.php" method="post">
				<div class="col-xs-8">
					<input class="form-control" placeholder="Codigo" type="codigo" name="codigo" id="codigo"/>
				</div>
