...
Auditoria("Accedio Al Modulo de Marca Listado",0);
...
<div class="header">Listado de Marcas
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_marca, descripcion, rif, razon_social from marcas, clientes where marcas.id_cliente = clientes.id_cliente order by descripcion asc"));
$r = pg_num_rows($rs);
if($r!=false && $r>0){ $i=1; 
while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(318,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Marca"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?marca=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(212,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Marca" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?marca=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(72,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Marca" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>

</div></td><td><?php echo $i;?></td>
<td><?php echo $r[1];?></td>
