...
if(isset($_SESSION['confunid'])){
$rs = pg_query("select * from confunid where id_confunid = ".$_SESSION['confunid']);
$r = pg_num_rows($rs);
if($r==false || $r<1){ 
	...
	Auditoria("Accedio Al Modulo Ver Configuracion de Unidades: $cod",$_SESSION['confunid']);
}
...
<div class="header">Ver Configuración de Unidades<a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
