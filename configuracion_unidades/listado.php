...
Auditoria("Accedio Al Modulo de Configuracion de Unidades Listado",0);
...
<div class="header">Listado Configuración de Unidades 
...
$rs = pg_query($link, filtrar_sql("select rif, razon_social, confunid.* from confunid, clientes where clientes.id_cliente = confunid.id_cliente and clientes.id_cliente = $c and (id_confunid = $t or $t < 1) order by nombre asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(317,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Configuración de Unidades"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?confunid=<?php echo $r[2];?>'"/>
<?php } ?>

<?php if ( in_array(211,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Configuración de Unidades" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?confunid=<?php echo $r[2];?>'" />
<?php } ?>

<?php if ( in_array(71,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Configuración de Unidades" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>

</div></td><td><?php echo $r[0]." ".$r[1];?></td>
<td><?php echo $r[4];?></td>
<td><?php echo $r[5];?></td>
</tr>
<?php } } ?>    
