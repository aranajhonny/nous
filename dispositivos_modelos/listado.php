...
$_SESSION['acc']['mod'] = 19;
$_SESSION['acc']['form'] = 29;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Modelos del Dispositivos Listado",0);
...
<div class="header">Listado Modelos de Dispositivo
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_dispmod, descripcion from dispmod order by descripcion asc"));
$r = pg_num_rows($rs);
if($r!=false && $r>0){ $i=1; while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(324,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Modelo de Dispositivo"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?dispmod=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(218,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Modelo de Dispositivo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?dispmod=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(78,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Modelo de Dispositivo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
