...
$_SESSION['acc']['mod'] = 25;
$_SESSION['acc']['form'] = 49;
include("../complementos/permisos.php");


Auditoria("Accedio Al Modulo de Magnitude Listado",0);
...
<div class="header">Listado de Magnitudes
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_magnitud, nombre, id_vista from magnitudes order by nombre asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ $i=1; while($r = pg_fetch_array($rs)){ 
$vista=" - - "; 
if($r[2]!=0){ $qs=pg_query("select descripcion from vistas where id_vista = ".$r[2]);
$qs = pg_fetch_array($qs); $vista = $qs[0]; }?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(329,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Magnitud"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?mag=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(223,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Magnitud" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?mag=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(83,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Magnitud" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
