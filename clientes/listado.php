...
$_SESSION['acc']['mod'] = 29;
$_SESSION['acc']['form'] = 65;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Cliente Listado",0);
...
<div class="header">Listado de Clientes 
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_cliente, rif, razon_social, direccion, telefono from clientes order by rif asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(333,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del cliente"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?cliente=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(227,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Cliente" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?cliente=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(87,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Cliente" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
