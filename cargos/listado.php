...
$_SESSION['acc']['mod'] = 28;
$_SESSION['acc']['form'] = 61;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Cargos Listado",0);
...
<div class="header">Listado de Cargos
...
<?php if ( in_array(332,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Cargo"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?cargo=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(226,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Cargo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?cargo=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(86,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Cargo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
