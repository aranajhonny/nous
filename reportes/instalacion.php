...
$cli = 10;
$rs = pg_query($link, filtrar_sql("select id_unidad, id_dispositivo from unidades where id_cliente = $cli and id_dispositivo <> 0 and (id_unidad = 1265) order by id_unidad asc "));
$i=0;
