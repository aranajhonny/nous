...
<td colspan='2' align='center'><h3 align='center'>HOJA DE INSTALACION</h3></td>
</tr><tr>
<td width='160' class='titulo'>CLIENTE:</td>
<td width='690' style='padding-left:10px;' >".$cli."</td>
</tr><tr>
...
<td colspan='2' align='center' style='padding:30px 0px 10px 0px;'>
...
<pagebreak type='NEXT-ODD' pagenumstyle='1' suppress='off' />";
