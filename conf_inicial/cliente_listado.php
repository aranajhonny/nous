...
if(isset($_REQUEST['eli'])){ 
	...
	if($rs){ 
		...
		Auditoria("En Configuración Inicial El Cliente fue Eliminado ",$id); 
	...
	Auditoria("En Configuración Inicial Accedio a Listado de Clientes", 0);
}
...
<div class="well">
<div class="header">Listado Clientes
<a href="cliente_agregar.php" target="clis" style="margin-left:380px; color:#2DB6FF;"><img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Cliente" style="margin-right:7px;" /> Agregar Cliente</a> </div>
...
<?php echo "<script>window.open('desabilitado.php?id=2','areas');</script>"; ?>
