...
((fecha_hora_gps)::time >= '06:00:00'::time and (fecha_hora_gps)::time <= '11:59:59'::time), ((fecha_hora_gps)::time >= '12:00:00'::time and (fecha_hora_gps)::time <= '17:59:59'::time), ((fecha_hora_gps)::time >= '18:00:00'::time  or (fecha_hora_gps)::time <= '05:59:59'::time) from unidades, log_gps, sensores where unidades.id_unidad = $id and log_gps.id_unidad = $id and log_gps.id_sensor = sensores.id_sensor and fecha_hora_gps between '".$dia[$k]." 00:00:00' and '".$dia[$k]." 23:59:59' order by log_gps.fecha_hora_gps asc "));
...
$data[$k]['punto'] .= "[$lat, $lng, '".$r[7].' '.$r[0]."', $tipo, 'Fecha y Hora: ".date3($r[3])."<br/>".$r[7].' '.$r[0]."<br/>Velocidad: ".(1*$r[1])." Km/Hr.<br/>Ref. ".(1*$r[5])." Km/Hr - ".(1*$r[4])." Km/Hr<br/>'],";
...
<div class="row">
	<div class="span11">
		<div id="map" style="width:770px; height:540px;"></div>
	</div>
</div>
</body>
</html>
