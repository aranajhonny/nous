...
$rs = pg_query($link, filtrar_sql("select dato, fecha_num, val_min, val_max, val_cri_min, val_cri_max, serial from log_sensor where id_control = $ctrl and id_unidad = $unid order by serial, fecha_evento asc ")); 
$detener=true;
while($detener) { 
$r = pg_fetch_array($rs);
