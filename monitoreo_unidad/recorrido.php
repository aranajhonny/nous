...
if(isset($_REQUEST['id'])==false){ 
	Auditoria("En Seguimiento de Unidad General Acceso Invalido al Recorrido",0);
...
<div id='wizard3'>       
<h2>Ultima Semana</h2><section><iframe src='ultima_semana.php?id=<?php echo $id;?>' name='recorrido1' id='recorrido1' height='600' width='720' scrolling='no' style='border:none;background:none;'></iframe></section>    
...
function fechas(){ 
	...
	if(ini.length>0 && fin.length>0){ 
		document.getElementById('fechas').src= "fechas.php?fi="+ini+"&ff="+fin+"&id="+<?php echo $id;?>;
	}
}
</script>
