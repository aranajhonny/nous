...
$rs = pg_query($link, filtrar_sql("select 
log_gps.dconfunid, 
unidades.codigo_principal, 
dato, 
geo_posicion, 
fecha_hora_gps, 
(fecha_hora_gps)::time, 
...
((fecha_hora_gps)::time >= '18:00:00'::time  or (fecha_hora_gps)::time <= '05:59:59'::time) from unidades, log_gps, log_sensor, sensores 
where 
unidades.id_unidad=$unid and 
log_gps.id_unidad=$unid and 
log_sensor.id_unidad=$unid and 
log_sensor.serial = '$serial' and 
fecha_hora_gps between '".$dia[$k]." 00:00:00' and '".$dia[$k]." 23:59:59' and 
fecha_evento between '".$dia[$k]." 00:00:00' and '".$dia[$k]." 23:59:59' and 
log_gps.id_transmision = log_sensor.id_transmision and 
log_gps.id_sensor = sensores.id_sensor  
...
$data[$k]['punto'] .= "[$lat, $lng, '".$r[0].' '.$r[1]."', $tipo, 'Fecha y Hora: ".date3($r[4])."<br/>Unidad: ".$r[0].' '.$r[1]."<br/>Puerta: $tipo2<br/>'],";
