...
$_SESSION['acc']['mod'] = 14;
$_SESSION['acc']['form'] = 13;
include("../complementos/permisos.php");


Auditoria("Accedio Al Modulo de Tipo de unidad Listado",0);
...
<div class="header">Listado de Tipo de Unidad
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_tipo_unidad, nombre from tipo_unidades order by nombre asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr>
<td><div class=" info-tooltip">

<?php if( $_SESSION['acc']['acl'] == 320 ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Tipo de Unidad"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?tipounid=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if( $_SESSION['acc']['acl'] == 214 ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Tipo de Unidad" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?tipounid=<?php echo $r[0];?>'" />
<?php } ?>

<?php if( $_SESSION['acc']['acl'] == 74){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Tipo de Unidad" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
