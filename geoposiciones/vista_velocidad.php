...
Auditoria("En Geoposición se Abrio la Vista de Velocidades para la Unidad: $titulo",$id);
...
$html="<div class='well'>
<div class='header'>Ultimas Velocidades Registradas<a class='headerclose'><i class='fa fa-times pull-right'></i></a> <a class='headerrefresh'><i class='fa fa-refresh pull-right'></i></a> <a class='headershrink'><i class='fa fa-chevron-down pull-right'></i></a></div>
...
<iframe src='velocidades.php' name='posicion' id='posicion' height='620' width='915' scrolling='no' style='border:none;background:none;'></iframe>
