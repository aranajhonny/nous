...
Auditoria("Accedio Al Modulo de Seguimiento Especifico",0);
...
<li><a href="#">Seguimiento de Unidad Específico</a></li>
...
<div class="form-group"><label>Vistas</label>
...
<option value="6">Notificaciones</option>
<option value="7">Historial</option>
</select></div>
</div>
...
function ver(id){ 
	var v = $('#vista').val();
	if(v!="0"){ 
		$.get('vista_general.php?id='+id+"&vista="+v, function(resultado){ 
		...
		mensaje('Debe Seleccionar Una Vista',1);
	}
}
