...
Auditoria("En Seguimiento de Unidad Especifico Acceso Invalido Archivo Controles",0);
	header("location: vacio.php");
	exit();
} else { 
	$id = filtrar_campo('int', 6, $_REQUEST['id']);
	$cli = filtrar_campo('int', 6, $_REQUEST['cli']);
}
...
<img src="../img/reload.png" height="15" width="15" onClick="window.open('<?php echo vistas($_REQUEST['id'], $r[1], 0, $r[3], -1);?>','ctrl<?php echo $i;?>');" style="margin-right:20px;"/>
...
<iframe src='<?php echo vistas($_REQUEST['id'], $r[1], 0, $r[3], -1);?>' name='ctrl<?php echo $i;?>' id='ctrl<?php echo $i;?>' height='620' width='820' scrolling='no' style='border:none;background:#none;'></iframe>
</div></div></div>
<?php $i++; ?>
<div class="panel panel-default">
<div class="panel-heading"><h4 class="panel-title">
<img src="../img/reload.png" height="15" width="15" onClick="window.open('<?php echo vistas($_REQUEST['id'], $r[1], 0, $r[3], -2);?>','ctrl<?php echo $i;?>');" style="margin-right:20px;"/>
...
<div id="collapse<?php echo $i;?>" class="panel-collapse collapse"><div class="panel-body">
<iframe src='<?php echo vistas($_REQUEST['id'], $r[1], 0, $r[3], -2);?>' name='ctrl<?php echo $i;?>' id='ctrl<?php echo $i;?>' height='620' width='820' scrolling='no' style='border:none;background:#none;'></iframe>
</div></div></div>
...
<div class="panel panel-default">
<div class="panel-heading"><h4 class="panel-title">
<img src="../img/reload.png" height="15" width="15" onClick="window.open('<?php echo vistas($_REQUEST['id'], $r[1], $r[2], $r[3], $r[0]);?>','ctrl<?php echo $i;?>');" style="margin-right:20px;"/>
<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $i;?>"><?php echo $i.".- ".$r[4]." / ".$r[5];?></a></h4></div>
<div id="collapse<?php echo $i;?>" class="panel-collapse collapse"><div class="panel-body">
<iframe src='<?php echo vistas($_REQUEST['id'], $r[1], $r[2], $r[3], $r[0]);?>' name='ctrl<?php echo $i;?>' id='ctrl<?php echo $i;?>' height='620' width='820' scrolling='no' style='border:none;background:#none;'></iframe>
</div></div></div>
<?php $i++; } } } ?>
