...
$v = $vm = $vM = $vcm = $vcM = "";
$rs = pg_query($link, filtrar_sql("select avg(dato), fecha_num, val_min, val_max, val_cri_min, val_cri_max from log_sensor where id_control = $ctrl and id_unidad = $unid group by fecha_num, val_min, val_max, val_cri_min, val_cri_max order by fecha_num asc")); 
