...
$_SESSION['acc']['mod'] = 20;
$_SESSION['acc']['form'] = 33;
include("../complementos/permisos.php");


Auditoria("Accedio Al Modulo de Tipo de Dispositivo Listado",0);
...
<li><a href="#">Tipos de Dispositivo</a></li>
...
<div class="header">Listado Tipos de Dispositivos 
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_tipo_disp, descripcion, cantidad from tipo_disp order by descripcion asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if( in_array(79,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Tipo de Dispositivo"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?tipo_disp=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if( in_array(219,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Tipo de Dispositivo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?tipo_disp=<?php echo $r[0];?>'" />
<?php } ?>

<?php if( in_array(325,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Tipo de Dispositivo" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
