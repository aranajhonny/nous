...
<div class="header">Listado Tipo de Mantenimientos
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_tipo_mant, nombre from tipo_mant order by nombre asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Tipo de Mantenimiento"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?tipomant=<?php echo $r[0];?>'"/>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Tipo de Mantenimiento" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?tipomant=<?php echo $r[0];?>'" />
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Tipo de Mantenimiento" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
