...
$_SESSION['acc']['mod'] = 36;
$_SESSION['acc']['form'] = 85;
include("../complementos/permisos.php");


Auditoria("Accedio Al Modulo de Tipo de Permiso Listado",0);

unset($_SESSION['tipo_perm']);
unset($_SESSION['tipoperm_cli']);
...
<li><a href="#">Tipos de Permiso</a></li>
...
<div class="header">Listado Tipos de Permiso
...
$rs = pg_query($link, filtrar_sql("select tipo_permisos.id_tipo_permiso, tipo_permisos.nombre, rif, razon_social, ci, 
personal.nombre from personal, tipo_permisos, clientes where 
id_responsable_general = personal.id_personal and 
tipo_permisos.id_cliente = clientes.id_cliente and 
(tipo_permisos.id_cliente = $c or $c = -1)
order by tipo_permisos.nombre asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ $i=1; while($r = pg_fetch_array($rs)){ ?>    
<tr>
<td><div class=" info-tooltip">

<?php if ( in_array(338,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Tipo de Permiso"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?tipoperm=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(232,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Tipo de Permiso" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?tipoperm=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(92,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Tipo de Permiso" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>
