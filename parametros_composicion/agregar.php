...
$sql="insert into paracomp(id_composicion, id_unidmed, dias_tolerancia, valor, porcentaje_tolerancia) values ($comp, $unid, $dias, $valor, $porc)";
	$rs = pg_query($sql);
	if($rs){ 
		$_SESSION['mensaje3']="Parámetro de Composición Agregado";
		header("location: listado.php");
		exit();
	} else { 
		$_SESSION['mensaje1']="No se logro agregar el Parámetro de Composición";
	}

} // si validar
} else { 
	$porc = 0; $comp = $unid = $dias = $valor = "";
}
...
<div class="header">Agregar Parámetro de Composición<a class="headerclose"><i class="fa fa-times pull-right"></i></a> <a class="headerrefresh"><i class="fa fa-refresh pull-right"></i></a> <a class="headershrink"><i class="fa fa-chevron-down pull-right"></i></a></div>
