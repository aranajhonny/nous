...
$_SESSION['acc']['mod'] = 52;
$_SESSION['acc']['form'] = 113;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Guia de Despacho Listado",0);

unset($_SESSION['guia']);
unset($_SESSION['guia_cliente']);
...
<div class="header">Listado de Guías de Despacho
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_guiadesp, guiadesp.codigo_principal, guiadesp.n_configuracion_01, guiadesp.n_configuracion_02, guiadesp.n_configuracion_03, confguia.nombre, guiadesp.factura, guiadesp.estatus from guiadesp, confguia where guiadesp.id_confguia = confguia.id_confguia order by confguia.nombre, guiadesp.codigo_principal asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){  ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(345,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Guía de Despacho"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?guia=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(239,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Guía de Despacho" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?guia=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(99,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Guía de Despacho" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>

</div></td><td><?php echo $r[5];?></td>
<td><?php echo $r[1];?></td>
<td><?php echo "#".$r[6];?></td>
<td><?php echo $r[7];?></td>
<td><?php echo $r[2];?></td>
