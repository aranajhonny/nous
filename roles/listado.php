...
$_SESSION['acc']['mod'] = 32;
$_SESSION['acc']['form'] = 73;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo de Roles Listado",0);
...
<div class="header">Listado Roles de Usuario
...
<table class="table table-striped table-bordered" id="managed-table">
	...
	<tbody>
<?php $rs = pg_query($link, filtrar_sql("select id_rol, descripcion from roles order by descripcion asc")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr>
<td><div class=" info-tooltip">

<?php if ( in_array(335,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos del Rol de Usuario"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?roles=<?php echo $r[0];?>'"/><?php } ?>

<?php if ( in_array(229,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos del Rol de Usuario" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?roles=<?php echo $r[0];?>'" /><?php } ?>

<?php if ( in_array(89,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nuevo Rol de Usuario" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" /><?php } ?>
