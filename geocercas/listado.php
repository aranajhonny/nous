...
$_SESSION['acc']['mod'] = 63;
$_SESSION['acc']['form'] = 164;
include("../complementos/permisos.php");

Auditoria("Accedio Al Modulo Geocercas Listado",0);
...
<div class="header">Listado Geocercas
...
$rs = pg_query($link, filtrar_sql("select id_geocerca, nom, cuando_alarma, hi, hf, tipo_geocerca from geocercas order by nom asc ")); 
$r = pg_num_rows($rs);
if($r!=false && $r>0){ while($r = pg_fetch_array($rs)){ ?>    
<tr><td><div class=" info-tooltip">

<?php if ( in_array(437,$_SESSION['acl']) ){ ?>
<img src="../img/search.png" width="15" height="15"  title="Ver datos de la Geocerca"  rel="tooltip" data-placement="right" onclick="location.href='ver.php?geo=<?php echo $r[0];?>'"/>
<?php } ?>

<?php if ( in_array(436,$_SESSION['acl']) ){ ?>
<img src="../img/pencil.png" width="15" height="15" title="Editar Datos de la Geocerca" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='editar.php?geo=<?php echo $r[0];?>'" />
<?php } ?>

<?php if ( in_array(435,$_SESSION['acl']) ){ ?>
<img src="../img/plus.png" width="15" height="15" title="Agregar Nueva Geocerca" style="margin-left:15px;"  rel="tooltip" data-placement="right" onclick="location.href='agregar.php'" />
<?php } ?>

</div></td>
<td><?php echo $r[1];?></td>
<td><?php echo tipo1($r[5]);?></td>
<td><?php echo tipo2($r[2]);?></td>
<td><?php echo horas($r[3])." / ".horas($r[4]);?></td>
</tr>
<?php } } ?>    
	</tbody>
</table>
